...
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCLpD7UvNiUCVDLMe0rlDHGRuQRLdPaPWk"></script>
...
var infowindow = new google.maps.InfoWindow({
  content:"Thapar University, Chandigarh"
  });
...
<nav>
    ...
    <a href="faculty.jsp" style="margin-right: 10px; margin-left: 200px;">faculty Login</a>
    <a href="student.jsp" style="margin-right: 10px; margin-left: 50px;">student Login</a>
    <a href="adminpage" style="margin-right: 10px; margin-left: 50px;"> Admin Login </a>
