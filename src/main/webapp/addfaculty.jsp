...
<form method="post" action="savefct">
    ...
    <p> <b>Faculty Name : </b></p> <input type="name" name="name" placeholder="Enter Faculty Name Please">
    <p> <b>Faculty city : </b></p> <input type="text" name="city" placeholder="Enter Faculty City Please">
    <p> <b>Faculty State </b></p> <input type="text" name="state" placeholder="Enter Faculty State Please">
    <p> <b>Faculty Email </b></p> <input type="email" name="email" placeholder="Enter Faculty Email Please">
    <p> <b>Faculty Subject </b></p> <input type="text" name="sname" placeholder="Enter Faculty Subject Please">    
<center>
<br/>
<br/>
